                ...
                <form onSubmit={handleSubmit} className="mt-8 space-y-4">
                            ...
                            <ul className="mt-2 space-y-1">
                                {PASSWORD_RULES.map((rule) => {
                                    ...
                                    return (
                                        <li
                                            key={rule.id}
                                            className={`flex items-center gap-2 text-xs ${passed ? "text-sage" : "text-paper/40"
                                                }`}
                                        >
                                            <span
                                                className={`flex h-3.5 w-3.5 items-center justify-center rounded-full text-[9px] ${passed ? "bg-sage text-ink" : "border border-paper/30"
                                                    }`}
                                            >
                                                {passed ? "✓" : ""}
                                            </span>
                    ...
                    <fieldset>
                        ...
                        <div className="grid grid-cols-2 gap-3">
                            <label
                                className={`flex cursor-pointer items-center justify-center rounded-xl border px-4 py-3 text-sm font-medium transition-colors ${form.role === "client"
                            ...
                            <label
                                className={`flex cursor-pointer items-center justify-center rounded-xl border px-4 py-3 text-sm font-medium transition-colors ${form.role === "freelancer"
                                        ? "border-signal/50 bg-signal/10 text-paper"
                                        : "border-white/10 bg-white/[0.02] text-paper/60"
                                    }`}
                            >
