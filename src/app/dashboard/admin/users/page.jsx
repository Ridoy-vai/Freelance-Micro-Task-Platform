...
import { GetAllUsers, ToggleUserBlock } from "@/ServerActions/admin";
...
const AdminuserAction = () => {
    ...
    const [actionId, setActionId] = useState(null); // কোন user-এর জন্য action চলছে
    const [selectedUser, setSelectedUser] = useState(null); // dialog-এ কোন user দেখাচ্ছে
    ...
    const handleToggleBlock = async (id, currentStatus) => {
        ...
        try {
            ...
            if (result?.success) {
                // UI instantly আপডেট হচ্ছে
                setUsers((prev) =>
                    prev.map((u) =>
                        u._id === id ? { ...u, isBlocked: nextStatus } : u
                    )
                );
            } else {
